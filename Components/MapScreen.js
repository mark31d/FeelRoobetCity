...
const MARKERS = [
  // viewpoints - на суше, равномерно распределены
  { placeId: 'monte_bre', title: 'Monte Brè', x: 0.08, y: 0.58 },
  { placeId: 'monte_san_salvatore', title: 'Monte San Salvatore', x: 0.24, y: 0.54 },
  { placeId: 'belvedere_gardens', title: 'Belvedere Gardens', x: 0.40, y: 0.56 },
  { placeId: 'castagnola_viewpoint', title: 'Castagnola Viewpoint', x: 0.56, y: 0.52 },
  { placeId: 'parco_san_michele', title: 'Parco San Michele', x: 0.72, y: 0.58 },
  // old town - на суше, равномерно распределены
  { placeId: 'piazza_della_riforma', title: 'Piazza della Riforma', x: 0.12, y: 0.64 },
  { placeId: 'via_nassa', title: 'Via Nassa', x: 0.28, y: 0.62 },
  { placeId: 'santa_maria_angioli', title: 'Santa Maria degli Angioli', x: 0.44, y: 0.66 },
  { placeId: 'cathedral_saint_lawrence', title: 'Cathedral of Saint Lawrence', x: 0.60, y: 0.60 },
  { placeId: 'contrada_verla', title: 'Contrada di Verla', x: 0.76, y: 0.64 },
  // lake - на суше, равномерно распределены
  { placeId: 'parco_ciani', title: 'Parco Ciani', x: 0.16, y: 0.70 },
  { placeId: 'lungolago', title: 'Lungolago', x: 0.32, y: 0.72 },
  { placeId: 'belvedere_park', title: 'Belvedere Park', x: 0.48, y: 0.68 },
  { placeId: 'cassina_agno_lakeside', title: 'Cassina d\'Agno Lakeside', x: 0.64, y: 0.70 },
  { placeId: 'gandria_village_walk', title: 'Gandria Village Walk', x: 0.80, y: 0.66 },
  // cafes - на суше, равномерно распределены
  { placeId: 'grand_cafe_al_porto', title: 'Grand Café Al Porto', x: 0.10, y: 0.74 },
  { placeId: 'caffe_vanini', title: 'Caffè Vanini', x: 0.26, y: 0.76 },
  { placeId: 'grand_cafe_lobby', title: 'Ristorante Grand Café Lobby', x: 0.42, y: 0.74 },
  { placeId: 'spaghetti_store', title: 'Spaghetti Store', x: 0.58, y: 0.76 },
  { placeId: 'manora_restaurant', title: 'Manora Restaurant', x: 0.74, y: 0.72 },
];
